function Jac = synaptic_plasticity_Jacobian(t, x, p) %, f_Ca)
    ...
    if nargin < 3 % nominal parameters
        % p = [k1, k2, k3, k4, k5, k6, k7, k8, c1, c2, c3, c4, Km1, Km2, Km3, Km4, Km5, K0, P0, Ktot, Atot, Ptot]
        p = [2, 15, 1, 120, 2, 15, 1, 80, 1, 1, 6, 8, 10, 0.3, 4, 10, 1, 0.5, 0.5, 20, 1, 20]; 
    end
