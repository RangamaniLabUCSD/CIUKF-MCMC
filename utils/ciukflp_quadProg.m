...
% CIUKFLP_QUADPROG run ciukf to estimate log posterior (ASSUMES linear measurements!)
%   logpost = ciukflp_quadProg(theta, x0, P0, f, H, Q, R, y, alpha,beta,kappa,eps, optOptions)
